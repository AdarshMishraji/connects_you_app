...
import 'package:connects_you/data/localDB/messageOps.dart';
...
class MessageOpsRepository {
  const MessageOpsRepository();

  final MessageOpsDataSource messageOpsDataSource =
      MessageOpsDataSource.instance;
